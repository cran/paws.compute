...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=ecs_continue_service_deployment]{continue_service_deployment} \tab Continues or rolls back an Amazon ECS service deployment that is paused at a lifecycle hook\cr
