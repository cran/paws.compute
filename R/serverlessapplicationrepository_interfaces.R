...
.serverlessapplicationrepository$create_application_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ApplicationId = structure(logical(0), tags = list(locationName = "applicationId", type = "string")), Author = structure(logical(0), tags = list(locationName = "author", type = "string")), CreationTime = structure(logical(0), tags = list(locationName = "creationTime", type = "string")), Description = structure(logical(0), tags = list(locationName = "description", type = "string")), HomePageUrl = structure(logical(0), tags = list(locationName = "homePageUrl", type = "string")), Labels = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "labels", type = "list")), LicenseUrl = structure(logical(0), tags = list(locationName = "licenseUrl", type = "string")), Name = structure(logical(0), tags = list(locationName = "name", type = "string")), ReadmeUrl = structure(logical(0), tags = list(locationName = "readmeUrl", type = "string")), SpdxLicenseId = structure(logical(0), tags = list(locationName = "spdxLicenseId", type = "string")), Version = structure(list(ApplicationId = structure(logical(0), tags = list(locationName = "applicationId", type = "string")), CreationTime = structure(logical(0), tags = list(locationName = "creationTime", type = "string")), ParameterDefinitions = structure(list(structure(list(AllowedPattern = structure(logical(0), tags = list(locationName = "allowedPattern", type = "string")), AllowedValues = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "allowedValues", type = "list")), ConstraintDescription = structure(logical(0), tags = list(locationName = "constraintDescription", type = "string")), DefaultValue = structure(logical(0), tags = list(locationName = "defaultValue", type = "string")), Description = structure(logical(0), tags = list(locationName = "description", type = "string")), MaxLength = structure(logical(0), tags = list(locationName = "maxLength", type = "integer")), MaxValue = structure(logical(0), tags = list(locationName = "maxValue", type = "integer")), MinLength = structure(logical(0), tags = list(locationName = "minLength", type = "integer")), MinValue = structure(logical(0), tags = list(locationName = "minValue", type = "integer")), Name = structure(logical(0), tags = list(locationName = "name", type = "string")), NoEcho = structure(logical(0), tags = list(locationName = "noEcho", type = "boolean")), ReferencedByResources = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "referencedByResources", type = "list")), Type = structure(logical(0), tags = list(locationName = "type", type = "string"))), tags = list(type = "structure"))), tags = list(locationName = "parameterDefinitions", type = "list")), RequiredCapabilities = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "requiredCapabilities", type = "list")), ResourcesSupported = structure(logical(0), tags = list(locationName = "resourcesSupported", type = "boolean")), SemanticVersion = structure(logical(0), tags = list(locationName = "semanticVersion", type = "string")), SourceCodeArchiveUrl = structure(logical(0), tags = list(locationName = "sourceCodeArchiveUrl", type = "string")), SourceCodeUrl = structure(logical(0), tags = list(locationName = "sourceCodeUrl", type = "string")), TemplateUrl = structure(logical(0), tags = list(locationName = "templateUrl", type = "string"))), tags = list(locationName = "version", type = "structure"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
